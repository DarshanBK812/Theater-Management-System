...
public class ApplicationExceptionHandler {
	...
	public ResponseEntity<ResponseStructure<String>> incomeNotFound(IncomeNotFound incomeNotFound) {
		responseStructure.setMessage("income not found in the DB");
		responseStructure.setStatuscode(HttpStatus.NOT_FOUND.value());
		responseStructure.setData(incomeNotFound.getMsg());
		return new ResponseEntity<ResponseStructure<String>>(responseStructure, HttpStatus.NOT_FOUND);
	}

	@ExceptionHandler(LimitExceeds.class)
	public ResponseEntity<ResponseStructure<String>> limitExceeds(LimitExceeds limitExceeds) {
		responseStructure.setMessage("LimitExceeds ! sorry Booking tickets  not available");
		responseStructure.setStatuscode(HttpStatus.BAD_REQUEST.value());
		responseStructure.setData(limitExceeds.getMessage());
		return new ResponseEntity<ResponseStructure<String>>(responseStructure, HttpStatus.BAD_REQUEST);
	}
	
	@ExceptionHandler(ResourcesNotFound.class)
	public ResponseEntity<ResponseStructure<String>> limitExceeds(ResourcesNotFound resourcesNotFound) {
		responseStructure.setMessage("No Such Data Available please contanct customer support");
		responseStructure.setStatuscode(HttpStatus.BAD_REQUEST.value());
		responseStructure.setData(resourcesNotFound.getMessage());
		return new ResponseEntity<ResponseStructure<String>>(responseStructure, HttpStatus.BAD_REQUEST);
	}
